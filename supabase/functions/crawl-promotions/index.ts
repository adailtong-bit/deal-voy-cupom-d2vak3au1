...
function isValidPromoLink(link: string): boolean {
  ...
  try {
    ...
    if (url.hostname.includes('ubereats.com') || url.hostname.includes('ifood.com.br') || url.hostname.includes('rappi.com')) {
        ...
        if (!url.pathname.includes('/item/') && !url.pathname.includes('?item_id=')) {
    ...
    if (url.hostname.includes('tacobell.com') || url.hostname.includes('mcdonalds.com') || url.hostname.includes('burgerking.com')) {
