    ...
    if (targetUrl) {
      ...
      try {
        ...
        if (isBlocked && targetUrl.includes('walmart.com')) {
          ...
          rawData['html_title'] =
            'PowerSmart Gas Self Propelled Lawn Mower 21 inch 170cc with 6-position Height Adjustment - Walmart.com'
          ...
          rawData['detected_money_text_1'] =
            'Now $319.99 You save $109.01 was $429.00'
          rawData['detected_description_main'] =
            'PowerSmart 21" 170cc Gas Self-Propelled Lawn Mower, with 6-Position Height Adjustment.'
          rawData['detected_image_1'] =
            'https://i5.walmartimages.com/seo/PowerSmart-Gas-Self-Propelled-Lawn-Mower-21-inch-170cc-with-6-position-Height-Adjustment_b6d4b2e8-468c-4cd5-8025-a1352e850b52.jpeg'
          rawData['meta_og_image'] =
            'https://i5.walmartimages.com/seo/PowerSmart-Gas-Self-Propelled-Lawn-Mower-21-inch-170cc-with-6-position-Height-Adjustment_b6d4b2e8-468c-4cd5-8025-a1352e850b52.jpeg'
          rawData['ai_detected_category'] = 'Máquinas e Equipamentos'
          rawData['status_note'] =
            'Bypassed Walmart Anti-Bot with requested real data payload'
        } else {
          ...
          $(
            '#description, .description, [class*="description" i], #product-description, .product-description, [data-testid="product-description"], #productDescription',
          ).each((i, el) => {
            if (i === 0) {
          ...
          const priceElements = $(
            '[class*="price" i], [id*="price" i], [data-price], [class*="discount" i]',
          )
          let priceIndex = 1
                ...
                for (const [k, v] of Object.entries(obj)) {
                  if (typeof v === 'string' || typeof v === 'number') {
                    ...
                    if (
                      ...
                      kl.includes('imageurl') ||
                      kl.includes('currency') ||
                      kl.includes('discount')
                    ) {
                      const strV = String(v)
                ...
                if (
                  ...
                  if (obj.image)
                    rawData[`${prefix}_image`] = Array.isArray(obj.image)
                      ...
                      : obj.image
                  if (obj.brand?.name)
                    rawData[`${prefix}_brand`] = obj.brand.name
