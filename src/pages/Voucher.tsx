...
export default function Voucher() {
  ...
  const { coupons, seasonalEvents, usedVouchers, validateCoupon } =
    useCouponStore()
    ...
    <div className="min-h-screen bg-slate-50/50 flex flex-col items-center py-8 px-4 sm:py-12 animate-fade-in-up">
      <div className="w-full max-w-md">
        ...
        <Card className="overflow-hidden border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl relative bg-white">
          ...
          <CardContent className="p-6 sm:p-8 flex flex-col items-center text-center pt-8">
            ...
            <p className="text-slate-500 font-medium mb-8">{storeName}</p>
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          <Button
            ...
            disabled={isUsed}
            className={cn(
              'w-full gap-2 font-bold h-14 text-base transition-all duration-300',
              isUsed
