...
//     USING: (((( SELECT users.email    FROM auth.users   WHERE (users.id = auth.uid())))::text = 'adailtong@gmail.com'::text) OR (( SELECT profiles.role    FROM profiles   WHERE (profiles.id = auth.uid())) = 'super_admin'::text) OR (( SELECT profiles.role    FROM profiles   WHERE (profiles.id = auth.uid())) = 'admin'::text))
//     WITH CHECK: (((( SELECT users.email    FROM auth.users   WHERE (users.id = auth.uid())))::text = 'adailtong@gmail.com'::text) OR (( SELECT profiles.role    FROM profiles   WHERE (profiles.id = auth.uid())) = 'super_admin'::text) OR (( SELECT profiles.role    FROM profiles   WHERE (profiles.id = auth.uid())) = 'admin'::text))
...
//     USING: (((( SELECT users.email    FROM auth.users   WHERE (users.id = auth.uid())))::text = 'adailtong@gmail.com'::text) OR (role = 'super_admin'::text) OR (role = 'admin'::text))
//     WITH CHECK: (((( SELECT users.email    FROM auth.users   WHERE (users.id = auth.uid())))::text = 'adailtong@gmail.com'::text) OR (role = 'super_admin'::text) OR (role = 'admin'::text))
