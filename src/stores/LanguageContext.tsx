...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    'travel.my_itinerary': 'Meus Roteiros',
    ...
    'travel.day': 'Dia',
    'travel.add_day': 'Adicionar Dia',
    'travel.calculate_route': 'Calcular Rota',
    'travel.origin': 'Ponto de Partida (Ex: Hotel)',
    'travel.destination': 'Destino (Ex: Universal)',
    'travel.stops': 'Paradas',
    'travel.optimize': 'Otimizar Rota',
    'travel.save_offline': 'Salvar Offline',
    'travel.agent_mode': 'Modo Agente',
    'travel.save_template': 'Salvar como Template',
  ...
  en: {
    ...
    'travel.day': 'Day',
    'travel.add_day': 'Add Day',
    'travel.calculate_route': 'Calculate Route',
    'travel.origin': 'Start Point (e.g., Hotel)',
    'travel.destination': 'Destination (e.g., Universal)',
    'travel.stops': 'Stops',
    'travel.optimize': 'Optimize Route',
    'travel.save_offline': 'Save Offline',
    'travel.agent_mode': 'Agent Mode',
    'travel.save_template': 'Save as Template',
  },
  es: {
    // ... existing ES translations ...
    'travel.day': 'Día',
    'travel.add_day': 'Añadir Día',
    'travel.calculate_route': 'Calcular Ruta',
    'travel.origin': 'Punto de Partida (Ej: Hotel)',
    'travel.destination': 'Destino (Ej: Universal)',
    'travel.stops': 'Paradas',
    'travel.optimize': 'Optimizar Ruta',
    'travel.save_offline': 'Guardar Offline',
    'travel.agent_mode': 'Modo Agente',
    'travel.save_template': 'Guardar como Plantilla',
  },
  fr: {
