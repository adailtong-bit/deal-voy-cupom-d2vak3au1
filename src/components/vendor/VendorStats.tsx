...
export function VendorStats({ company, activeCampaigns }: any) {
  const { validationLogs, coupons } = useCouponStore()
  ...
  const stats = useMemo(() => {
    ...
    // Calculate a mock revenue based on redemptions
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8 animate-fade-in-up">
      ...
      <Card className="shadow-sm border-slate-200 bg-white">
        ...
        <CardContent>
          ...
          <p className="text-xs text-slate-500 mt-1">Based on avg. ticket</p>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-sm border-slate-200 bg-white">
        ...
        <CardContent>
          ...
          <p className="text-xs text-slate-500 mt-1">Active / Scheduled</p>
        </CardContent>
      </Card>
    </div>
  )
