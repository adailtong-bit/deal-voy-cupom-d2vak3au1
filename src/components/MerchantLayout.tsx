...
export default function MerchantLayout() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-4rem)] bg-slate-50/50">
      <aside className="hidden md:flex w-64 flex-col border-r bg-white min-h-[calc(100vh-4rem)] py-6 px-4">
        <div className="mb-6 px-2">
          <h2 className="text-lg font-bold text-slate-800">Área do Lojista</h2>
          <p className="text-sm text-slate-500">Gerencie seu negócio</p>
        </div>
